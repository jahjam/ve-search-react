...
import ResultsCard from '../temps/ResultsCard/ResultsCard';
import GhostCard from '../temps/GhostCard/GhostCard';
...
const Results = props => {
  ...
  return (
    ...
    >
      <Styled.ResultsBtn onClick={leftArrowHandler} btnSize="large">
        <LeftArrow />
      </Styled.ResultsBtn>
      <Styled.RecipeResults ref={recipeResults}>
      ...
      </Styled.RecipeResults>
      <Styled.ResultsBtn onClick={rightArrowHandler} btnSize="large">
        <RightArrow />
      </Styled.ResultsBtn>
    </Styled.Results>
  );
